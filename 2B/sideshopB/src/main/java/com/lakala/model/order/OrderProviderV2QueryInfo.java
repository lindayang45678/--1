...
public class OrderProviderV2QueryInfo implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4904384422928629941L;
	...
	private String custremark;  //买家备注
	
	private OrderDateInfoV2 orderdatequeue;
	
	private List<OrderItemsInfo> orderitemslist;   //该订单所属的供应商下的商品子订单列表

	public String getTallorderid() {
		return tallorderid;
	}

	public void setTallorderid(String tallorderid) {
