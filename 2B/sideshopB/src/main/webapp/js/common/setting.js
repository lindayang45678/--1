...
/* 营业开始时间  */
var businessStartTime = storage.getItem("businessStartTime") || "";

/* 营业结束时间  */
var businessEndTime = storage.getItem("businessEndTime") || "";

/* 起送金额 */
var minAmount = storage.getItem("minAmount") || "";

/* 运费  */
var transportExpense = storage.getItem("transportExpense") || "";

/* 单笔满多少钱免运费  */
var singleFreeExpense = storage.getItem("singleFreeExpense") || "";
...
/* 订单类型--45:APP-C频道; 44:批发订单; 28:零售订单; */
var channelcode2C = 45;
var channelcodePF = 44;
...
/*促销类型 190：团购   191：抢购  192：抽奖   66：订单满赠     67：订单满减    68：订单返现   69：订单补贴    70：商品直降    71：商品买赠    72：加价购*/
var promoTypeTuan = 190;
var promoTypeQiang = 191;
var promoTypeLottery = 192;
var promoTypeManZeng = 66;
var promoTypeManJian = 67;
var promoTypeFanXian = 68;
var promoTypeBuTie = 69;
var promoTypeZhiJiang = 70;
var promoTypeMaiZeng = 71;
var promoTypeJiaGou = 72;
...
/* 请输入准确的详细地址信息！*/
var msgDetailAddressEmpty = "请输入准确的详细地址信息！";
/* 身份证号不能为空！*/
var msgId_noEmpty = "身份证号不能为空！";
/* 身份证号不合法！*/
var msgId_NotLegal = "请输入正确的身份证号！";
/* 身份证正面不能为空！*/
...
/* couponuse:0 很抱歉，购物车的限购商品，您已达到最大限购数，不可继续购买 */
var msgCouponsNotForPurchaseProduct = "抱歉，购物车的限购商品，您已达到最大限购数，不可继续购买";
...
/*订单时间轴-超过1小时未支付，订单取消*/
var msgTimelineCancelSystem = "超过1小时未支付，订单取消";
/*零售订单时间轴*/
/*零售订单时间轴-下单成功*/
...
/* 很抱歉，该分类未关联2C营销分类，不能添加商品！ */
var msgNoAddProductForNotCatalog = "很抱歉，该分类未关联2C营销分类，不能添加商品！";
/* 二次支付请求超时*/
var msgToPayTimeOut = "很抱歉，支付结果返回超时，可进入【订单管理】，查看订单是否支付成功！";
/* 营业开始或结束时间 输入错误*/
var msgStartEndFormatError="营业开始或结束时间 输入错误！";
/* 单笔满多少钱免运费不能小于起送金额*/
var msgFullFreeError="单笔满免金额不能小于起送金额！";
/* 起送金额不能为空或格式错误*/
var msgFromAmountNotEptFmtError="起送金额为空或格式错误！";
/* 起送金额不能为空或格式错误*/
var msgFreightNotEptFmtError="运费为空或格式错误！";
/* 起送金额不能为空或格式错误*/
var msgFullFreeNotEptFmtError="单笔满免金额为空或格式错误！";
/* 配送员手机号不能 与店主相同*/
var deliveryStaffPhoneError="很抱歉，不能填写店主手机，如本店无配送员可不填写！";
/* 小店升级开放城市  */
var CityList = "110000";
...
/* 自营日列表接口地址*/
var urlGetCycleOwnDateEarningsList = "../../profit/getCycleOwnDateEarningsList";
/* 登录接口地址 */
...
/* 我的小店商品推荐接口  */
var urlRecGoods = "../../goods/recommendgoods";
/* 店主取货验证码接口地址 */
...
/* 获取2B使用的所有虚分类（即营销分类）只返回关联了结算分类 */
var urlgoodsqueryallvirtualcat = "../../goods/queryallvirtualcat";
/* 获得平台商品详情  */
...
/* 我的小店商品推荐上架接口  */
var urlPushGood = "../../goods/addbatchrecommendgoods";
/* 我的小店商品推荐接口  */
var urlRecGoods = "../../goods/recommendgoods";
/* 消息通知接口 */
var urlGetNewsInfo = "../../news/getInfo";
/* 消息通知接口2 */
var urlGetNewsList = "../../news/messagelist2b";
/* 上传图片  */
...
/*小店信息更新*/
var urlUptShopAddInfo = "../../shop/uptShopAddInfo";
/* 二次支付接口*/
var urlOrdertopay = "../../order/nopay/topay";

/* 地址切换--本机地址:1; 测试地址:2; 生产地址:3; */
var globalStatus = 3;
if(window.location.href.indexOf("appmts.lakalaec.com") < 0) {
	globalStatus = 2;
}

if(globalStatus == 1) {
	/* 图片服务器地址*/
	var urlImage = "http://10.5.12.203/product";
	/* 广告图片服务器地址*/
