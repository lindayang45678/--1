...
function scrollRight(){
	rightScroll = new iScroll("index-content", {hScrollbar:false, vScrollbar:false, checkDOMChanges:true, onScrollStart:function() {rightScroll.refresh();}});
}
