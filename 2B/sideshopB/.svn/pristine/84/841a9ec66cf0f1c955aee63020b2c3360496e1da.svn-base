...
function osFixed(){
	if(osType() == "ios"){
		$(".container").on("focus", "input", function(){
			...
			$("header").addClass("osfixed");
			$(".container").removeClass("editshop").css("margin-top","6px");
		}).on("focusout", "div", function(){
			$("header").removeClass("osfixed");
			$(".container").addClass("editshop").removeAttr("style");
		})
	}
}
...
/**
 * 售后审核状态   退货待审核298、退货审核不通过299、待退货300、已退货301、退款待审核303、退款审核不通过304、待退款305、已退款306
 * @param returntstate
 * @returns {String}
 */
