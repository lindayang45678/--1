...
$(function() {
	...
	$(".content1").css("padding-bottom","90px");
});
...
/* 小店管理获取本店 右侧商品 */
var type = 0;
function sideshopgoodslist(objid, isFirst) {
	var goodcontainer = $(".content1");
	var ret = "";
	var data = {"psam":psam, "channelid":channelcode2C, "virtualcatid":objid, "type":type};
